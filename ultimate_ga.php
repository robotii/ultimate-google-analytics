...
Version: 1.6.1
Author: Wilfred van der Deijl (Modified by Peter Arthur)
...
/* 
  ...
  version 1.6.1
    +: Updates to the Google Analytics tracking code to improve loading time 
       (by Peter Arthur)
...
function uga_options()
{
    ...
    if (isset($_POST['factory_settings'])) {
        ...
        ?>
        <div class="updated"><p>
            <strong><?php _e('Factory settings restored, remember to set Account ID', 'uga') ?></strong></p></div><?php
    }
    ...
    <form method="post">
        ...
        <fieldset class="options" name="general">
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="editform">
                <tr>
                    ...
                    <td><input name="account_id" type="text" id="account_id"
                               value="<?php echo uga_get_option('account_id'); ?>" size="50"/>
                        <br/>Enter your Google Analytics account ID. Google Analytics supplies you with a snippet of
                        JavaScript to put on
                        your webpage. In this JavaScript you can see your account ID in a format like UA-999999-9. There
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="check_updates" id="check_updates"
                               value="true" <?php if (uga_get_option('check_updates')) echo "checked"; ?> />
                        <br/>Check for updates to the Ultimate Google Analytics plugin
                        <?php if (uga_get_option('check_updates')) {
                            echo "<br /><strong>Result</strong>: ";
                            uga_check_updates(true);
                        } ?>
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%"><?php _e('Enable tracker', 'uga') ?></th>
                    <td><input type="checkbox" name="enable_tracker" id="enable_tracker"
                               value="true" <?php if (uga_get_option('enable_tracker')) echo "checked"; ?> />
                ...
                <tr<?php if (!uga_get_option('advanced_config')) echo ' style="display:none;"'; ?>>
                    ...
                    <td><input type="checkbox" name="track_adm_pages" id="track_adm_pages"
                               value="true" <?php if (uga_get_option('track_adm_pages')) echo "checked"; ?> />
                        <br/>Enable or disable the inclusion of Google Analytics tracking on the admin pages of
                        Wordpress.
                    </td>
                </tr>
                <tr<?php if (!uga_get_option('advanced_config')) echo ' style="display:none;"'; ?>>
                    <th nowrap valign="top" width="33%"><?php _e('Ignore logged on users', 'uga') ?></th>
                    <td><input type="checkbox" name="ignore_users" id="ignore_users"
                               value="true" <?php if (uga_get_option('ignore_users')) echo "checked"; ?> />
                        of level <input name="max_user_level" type="text" id="max_user_level"
                                        value="<?php echo uga_get_option('max_user_level'); ?>" size="2"/> and above
                        <br/>Check this checkbox and specify a user level to ignore users of a particular level or
                        above. For such users the
                ...
                <tr<?php if (!uga_get_option('advanced_config')) echo ' style="display:none;"'; ?>>
                    ...
                    <td><input type="checkbox" name="debug" id="debug"
                               value="true" <?php if (uga_get_option('debug')) echo "checked"; ?> />
        ...
        <fieldset class="options"
                  name="external" <?php if (!uga_get_option('advanced_config')) echo ' style="display:none;"'; ?>>
            <legend><?php _e('Links tracking', 'uga') ?></legend>
            <table width="100%" cellspacing="2" cellpadding="5"
                   class="editform" <?php if (!uga_get_option('advanced_config')) echo ' style="display:none;"'; ?>>
                <tr>
                    <th nowrap valign="top" width="33%"><?php _e('Filter content', 'uga') ?></th>
                    <td><input type="checkbox" name="filter_content" id="filter_content"
                               value="true" <?php if (uga_get_option('filter_content')) echo "checked"; ?> />
                        <br/>Enable or disable tracking of links in the content of your articles. Which type(s) of links
                        should be tracked can be selected with the other options. If you plan to disable all of them,
                        you
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="filter_comments" id="filter_comments"
                               value="true" <?php if (uga_get_option('filter_comments')) echo "checked"; ?> />
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="filter_comment_authors" id="filter_comment_authors"
                               value="true" <?php if (uga_get_option('filter_comment_authors')) echo "checked"; ?> />
                        <br/>Enable or disable tracking of links in the comments footer showing the author.
                        If you plan to disable all filters, you are better of disabling the entire filtering to save
                        performance.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="track_ext_links" id="track_ext_links"
                               value="true" <?php if (uga_get_option('track_ext_links')) echo "checked"; ?> />
                        and prefix with <input name="prefix_ext_links" type="text" id="prefix_ext_links"
                                               value="<?php echo uga_get_option('prefix_ext_links'); ?>" size="40"/>
                ...
                <tr>
                    ...
                    <td><input name="internal_domains" type="text" id="internal_domains"
                               value="<?php echo uga_get_option('internal_domains'); ?>" size="50"/>
                        <br/>Hostname(s) that are considered internal links. Links to these hosts are not tagged as
                        external link.
                        You can specify multiple hostnames separated by commas. This list of internal hostnames is also
                        used
                        for tagging download links (see below). Download links have to be of a specified file type and
                        it has
                        to an internal link. An internal link can either be a relative link (without a hostname) or a
                        link that starts
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="track_files" id="track_files"
                               value="true" <?php if (uga_get_option('track_files')) echo "checked"; ?> />
                        and prefix with <input name="prefix_file_links" type="text" id="prefix_file_links"
                                               value="<?php echo uga_get_option('prefix_file_links'); ?>" size="40"/>
                        <br/>Include code to track internal (within your own site) links to certain file types and
                        specify what prefix should be used in the
                ...
                <tr>
                    ...
                    <td><input name="track_extensions" type="text" id="track_extensions"
                               value="<?php echo uga_get_option('track_extensions'); ?>" size="50"/>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="track_mail_links" id="track_mail_links"
                               value="true" <?php if (uga_get_option('track_mail_links')) echo "checked"; ?> />
                        and prefix with <input name="prefix_mail_links" type="text" id="prefix_mail_links"
                                               value="<?php echo uga_get_option('prefix_mail_links'); ?>" size="40"/>
                        <br/>Include code to track mailto: links to email addresses and specify what prefix should be
                        used in the
...
// will return an empty string if tracking for this type of URL is disabled
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(["_setAccount", "' . uga_get_option('account_id') . '"]);
